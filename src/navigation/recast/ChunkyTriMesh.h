...
// Axis-aligned bounding box tree node used to quickly select triangles per tile.
...
// ChunkyTriMesh holds a BVH tree over triangles, mirroring RecastDemo's implementation.
